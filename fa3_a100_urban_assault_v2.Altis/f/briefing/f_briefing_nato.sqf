...
<br/>
1) Copy data from the devices at <marker name = 'mrkEastObj'>East Objective</marker> or <marker name = 'mrkWestObj'>West Objective</marker> and <marker name ='mrkExfilBlufor'>exfil</marker>.
<br/><br/>
ALTERNATIVELY
<br/><br/>
2) Kill OPFOR
...
<br/>
AAF have a device they've kept in Kavala. We don't know what it is, so we want to hack into it. Problem is, so does OPFOR.
<br/><br/>
