...
<br/>
1) Destroy the devices at both <marker name = 'mrkEastObj'>East Objective</marker> and <marker name = 'mrkWestObj'>West Objective</marker> and <marker name ='mrkExfilBlufor'>exfil</marker>.
<br/><br/>
ALTERNATIVELY
<br/><br/>
2) Kill OPFOR
...
<br/>
AAF have two devices they've kept in Kavala. We don't know what they are, but we want to blow them up. Problem is, so does OPFOR.
<br/><br/>
<font size='18'>ENEMY FORCES</font>
<br/>
CSAT Infantry Platoon of identical strength to ours.
<br/><br/>
<font size='18'>FRIENDLY FORCES</font>
<br/>
NATO Infantry Platoon with 2 MMG attachments.
"]];
