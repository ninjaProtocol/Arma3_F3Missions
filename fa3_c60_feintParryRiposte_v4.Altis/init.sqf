...
f_var_viewDistance_fixedWing = 8000;
...
// BLUFOR > NATO
 [BLUFOR,80,2] execVM "f\casualtiesCap\f_CasualtiesCapCheck.sqf";
...
// F3 - PreMount component - shifted here from ingame game logic for Eden compatibility
...
[synchronizedObjects F3_preMount_NATO_2,["GrpNATO_CSL","GrpNATO_C1","GrpNATO_C2","GrpNATO_ENG1"],true,false] call f_fnc_mountGroups;
[synchronizedObjects F3_preMount_NATO_3,["GrpNATO_CO","GrpNATO_DC"],false,false] call f_fnc_mountGroups;
