...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		...
		["GrpNATO_CSL", 0, "ZSL", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpNATO_C1", 1, "Z1", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpNATO_C2", 1, "Z2", "ColorGreen"] spawn f_fnc_localGroupMarker;
		...
		["UnitNATO_CSL_M", 0, "ZM", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
