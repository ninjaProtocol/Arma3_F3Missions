...
// Markers seen by players in CSAT slots.
	...
	case "opf_f":
	{
		...
		["GrpCSAT_ENG1",  6, "ENG1", "ColorOrange"] spawn f_fnc_localGroupMarker;
 		...
 		["GrpCSAT_VIC1",  3, "VIC1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_VIC2",  3, "VIC2", "ColorOrange"] spawn f_fnc_localGroupMarker;
		...
		["UnitCSAT_DC_FTD", 2, "FT", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
		["UnitCSAT_DC_MTD", 2, "MT", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
		["UnitCSAT_DC_RTD", 2, "RT", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
	};
...
// Markers seen by players in AAF slots.
	...
	case "ind_f":
	{
		...
		["GrpAAF_T2",  7, "IFV2", "ColorOrange"] spawn f_fnc_localGroupMarker;
