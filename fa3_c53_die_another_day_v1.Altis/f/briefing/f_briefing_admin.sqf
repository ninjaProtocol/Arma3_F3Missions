...
AAF uses a CSAT TS3 channel. Probably just a single channel should be enough. Only AAF SLs (actual or acting) and Tank Commanders are allowed on CC. 
Global markers are NOT allowed during briefing, only while in game. Same goes for comms between CSAT and AAF.
<br/><br/>
";
